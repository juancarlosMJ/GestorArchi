    ...
    <body >
        ...
        $(function(){
            var fechaA = new Date();//permete seleccionar años hacia abajo
            var yyyy = fechaA.getFullYear();//permite selecionar años 
            ...
            function agregarUsuarioNuevo(){
                $.ajax({
                    ...
                    success: function(respuesta){
                        ...
                        if(respuesta == 1){
                            $('#frmRegistro')[0].reset(); //limpia nuestro formulario 
                            swal("n_n","Agregado con exito","success");
                        }else if(respuesta == 2){
                            swal("Este usuario ya existe, no se puede agregar");
                        }else{
                            swal("u_u","No se pudo agregar","Error");
                        }
                    }
                });
